    ...
    <div className="max-w-4xl mx-auto p-6 bg-white">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center py-4 border-b border-gray-100">
          ...
          <div className="md:col-span-2">
            <span className="text-gray-900">{serviceName || "auth-scopes"}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center py-4 border-b border-gray-100">
          ...
          <div className="md:col-span-2">
            <span className="text-gray-900 font-mono text-sm">{serviceCode || "52a424267f625ddd196d2aac70f"}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start py-4 border-b border-gray-100">
          ...
          <div className="md:col-span-2">
            <span className="text-gray-900">{description || "Authentication Scope Role"}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center py-4 border-b border-gray-100">
          ...
          <div className="md:col-span-2">
            <span className="text-gray-900">{lastModified || "28/05/2025"}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center py-4 border-b border-gray-100">
          ...
          <div className="md:col-span-2">
            <span className="text-gray-900">{modifiedBy || "yutita.ka"}</span>
          </div>
        </div>
      </div>
