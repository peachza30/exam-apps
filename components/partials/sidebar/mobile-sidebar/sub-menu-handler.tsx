...
const SubMenuHandler = ({ item, toggleSubmenu, index, activeSubmenu, collapsed }: { item: any; toggleSubmenu: any; index: number; activeSubmenu: number | null; collapsed: boolean }) => {
  const { title } = item;
