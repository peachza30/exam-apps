    ...
    <div className="px-4 py-4 ">
      <div className=" flex items-center">
        <div className="flex flex-1 items-center gap-x-3  ">
          <Image src={SiteLogo} alt="SiteLogo" className="h-8 w-8" />
          {(!collapsed || hovered) && <div className="flex-1  text-xl text-primary  font-semibold">TFAC Backoffice</div>}
        </div>
        {sidebarType === "classic" && (!collapsed || hovered) && (
          ...
          ${collapsed ? "" : "ring-2 ring-inset ring-offset-4 ring-default-900  bg-default-900  dark:ring-offset-default-300"}
          `}
            ></div>
          </div>
        )}
