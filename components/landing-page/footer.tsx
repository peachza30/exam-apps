      ...
      <div className="py-16 2xl:py-[120px]">
        <div className="max-w-[700px] mx-auto flex flex-col items-center relative">
          <Link href="/" className="inline-flex items-center gap-4 text-primary-foreground">
            <Image src={SiteLogo} alt="SiteLogo" className="w-[50px] h-[52px]" />
            <span className="text-3xl font-semibold">TFAC BackOffice</span>
          </Link>
          <p className="text-base leading-7 text-default-200 dark:text-default-600 text-center mt-3">DashTail is a developer-friendly, ready-to-use admin template designed for building attractive, scalable, and high-performing web applications, powered by the cutting-edge technologies of Next.js and Tailwind CSS.</p>
      ...
      <div className="relative bg-default-900 dark:bg-default-50 py-6">
        <div className="container flex flex-col text-center md:text-start md:flex-row gap-2">
          ...
          <p className="text-primary-foreground flex-none text-base font-medium">
            ...
            <Link href="https://codeshaper.net" target="__blank" className="text-primary hover:underline">
              Codeshaper
            </Link>
          </p>
        </div>
